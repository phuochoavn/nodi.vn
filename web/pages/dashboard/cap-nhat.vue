      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div class="p-6">
          ...
          <div @dragover.prevent="dragOver = true" @dragleave="dragOver = false" @drop.prevent="handleDrop"
            ...
            <input ref="fileInput" type="file" accept=".exe,.msi,.zip,.apk" class="hidden" @change="handleFileSelect" />
            <div v-if="!selectedFile" class="space-y-2">
              ...
              <p class="text-xs text-slate-400">.exe, .msi, .zip, .apk — Tối đa 500 MB</p>
            </div>
