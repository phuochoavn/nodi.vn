...
const plans = [
  ...
  {
    name: 'Theo tháng', price: '299.000đ', period: '/tháng', description: 'Dùng thử PRO 1 tháng • Hủy bất cứ lúc nào',
    features: [
      { text: 'Bán hàng không giới hạn đơn' },
      { text: 'Quản lý sản phẩm, khách hàng, NCC' },
      { text: 'Nhập hàng, tồn kho, lô hàng' },
      { text: 'Báo cáo chi tiết (doanh thu, lãi/lỗ, top SP)' },
      { text: 'Xuất Excel' },
    ...
    cta: { text: 'Mua ngay — Miễn phí 1 tháng đầu', link: '/thanh-toan' },
  },
  {
...
const faqs = [
  { q: 'Dùng được mấy thiết bị?', a: '1 license key = 1 cửa hàng = tối đa 10 thiết bị (PC + Mobile). Nhân viên dùng điện thoại riêng quét QR để liên kết vào cửa hàng.' },
  { q: 'Có thể quản lý nhiều cửa hàng không?', a: 'Được! 1 tài khoản có thể quản lý nhiều cửa hàng. Mỗi cửa hàng cần 1 license key riêng.' },
  { q: 'Free và Pro khác gì?', a: 'Chỉ khác duy nhất giới hạn đơn hàng: Free giới hạn 20 đơn/ngày, Pro không giới hạn. Tất cả tính năng đều giống nhau.' },
  ...
  { q: 'Sau 30 ngày dùng thử thì sao?', a: 'Phần mềm vẫn sử dụng được miễn phí với đầy đủ tính năng, chỉ giới hạn 20 đơn hàng/ngày. Nâng cấp PRO để không giới hạn.' },
  { q: 'Mua Pro có được dùng thử không?', a: 'Có! Khi mua key Pro, bạn được dùng thử Pro 1 tháng đầu tiên.' },
]
</script>
